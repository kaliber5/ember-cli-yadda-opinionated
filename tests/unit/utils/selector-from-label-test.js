...
const cases = [
  ...
  { input: 'a FooBar(Baz)',  expected: '[data-test-foo-bar="Baz"]:eq(0)' },
  ...
  { input: 'a FooBar under the 33rd Baz-Quux in Zomg', expected: '[data-test-zomg] [data-test-baz-quux]:eq(32) [data-test-foo-bar]:eq(0)' },
